            ...
            <div className="w-full max-w-screen-2xl mx-auto flex flex-col gap-40">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 mb-40">
                    {[
                        ...
                        <div key={i} className="flex flex-col gap-8 border-t border-neutral-900 pt-16">
                            <span className="font-heading text-step--1 uppercase tracking-micro text-neutral-600">SYS // 0{i + 1}</span>
                            <h3 className="font-heading text-step-0 font-bold uppercase tracking-micro text-white">{mod.title}</h3>
                            <p className="font-body text-step-2 text-neutral-500 font-light max-w-[40ch] leading-snug">{mod.focus}</p>
                        </div>
                    ))}
                </div>
                ...
                <div className="border-t border-neutral-900 pt-20 pb-40 flex justify-between items-baseline">
                    ...
                    <a href="https://github.com/darshit-lagdhir/Polyglot-Contract-Verifier" target="_blank" className="font-title text-step-4 text-white uppercase tracking-tight-title hover:italic transition-all duration-700">
                        Source
                    </a>
                </div>
