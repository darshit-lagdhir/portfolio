  ...
  return (
    <div className="min-h-screen bg-bg-primary text-text-primary flex items-center justify-center p-sys-32">
      ...
      >
        ...
        <h2 className="type-h2 mb-sys-24 text-white">SYSTEM_STATE_CORRUPTED_</h2>
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="type-nav text-[0.7rem] text-text-muted hover:text-white transition-colors py-2 border border-transparent hover:border-border-dim"
          >
        ...
        <div className="absolute -bottom-16 -right-16 opacity-[0.03] select-none pointer-events-none">
          <span className="type-identity text-[8rem]">ERR</span>
        </div>
      </motion.div>
    </div>
  );
