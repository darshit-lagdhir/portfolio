  ...
  return (
    <div className="flex flex-col pb-sys-128">
      ...
      */}
      ...
      {/* Visual Anchor Metadata - Stabilized in bottom-right with improved visibility */}
      <div className="fixed bottom-4 right-4 md:bottom-sys-32 md:right-sys-32 pointer-events-none z-[70]">
        <div className="type-metadata opacity-40 text-[0.4rem] md:text-[0.5rem] bg-bg-primary/90 backdrop-blur-xl p-2 eng-bracket border border-border-dim/50">
